...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($select_users) > 0){
        ...
        if($pass != $cpass){
            ...
            mysqli_query($conn, "INSERT INTO `electrician`(fname, lname, username, email, password, user_type) 
                VALUES('$fname', '$lname', '$user_name', '$email', '$cpass', '$user_type')") or die('query failed');
  ...
  <body>
    <div class="register-page">
        ...
        <form class="register-part" method="post" action="">
            <div class="register-yourself">Register Your Worker</div>
